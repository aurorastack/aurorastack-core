...
GRPC_EXTENSION_SERVICERS = {
    'aurorastack.core.pygrpc.extension.grpc_health': ['GRPCHealth'],
    'aurorastack.core.pygrpc.extension.server_info': ['ServerInfo']
}
...
REST_EXTENSION_ROUTERS = [
    {
        'router_path': 'aurorastack.core.fastapi.extension.health:router',
        'router_options': {}
    }
]
