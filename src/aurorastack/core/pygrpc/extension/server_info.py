...
from aurorastack.api.core.v1 import server_info_pb2, server_info_pb2_grpc
...
class ServerInfoManager(object):
    ...
    def _get_version_from_pkg(service):
        try:
            ...
            return pkg_resources.get_distribution(f'aurorastack-{service}').version
    ...
    def _get_version_from_file(service):
        try:
            module = __import__(f'aurorastack.{service}', fromlist=[service])
