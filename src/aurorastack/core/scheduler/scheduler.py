...
from aurorastack.core.error import ERROR_CONFIGURATION
from aurorastack.core.scheduler.task_schema import AURORA_TASK_SCHEMA
...
class BaseScheduler(Process):
    ...
    def push_task(self):
        ...
        for task in tasks:
            try:
                validate(task, schema=AURORASTACK_TASK_SCHEMA)
